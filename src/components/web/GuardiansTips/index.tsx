    ...
    <Fragment>
      <Box marginBottom="12px">
        <TextBody textAlign="center">
          Choose trusted friends or use your existing Ethereum wallets as guardians.{' '}
          <Text onClick={toggleTips} color="#EC588D" cursor="pointer">
            Show {showTips ? 'less' : 'more'}
          </Text>
        </TextBody>
      </Box>
      {showTips && (
        ...
        >
          <Box>
            ...
            <TextBody marginBottom="1em">
              ...
              Wallets as your guardians. If choosing a Soul Wallet as one of your guardians, ensure it's currently setup
              on Ethereum for social recovery.
            </TextBody>
