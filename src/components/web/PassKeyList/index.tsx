...
export default function PassKeyList({ passKeys }: any) {
  return (
    <Box display="flex" alignItems="flex-start" justifyContent="center" flexDirection="column" width="100%">
      ...
      {passKeys.map((passKey: string, i: number) => (
        <Box key={i} background="white" borderRadius="16px" padding="16px" width="100%" marginBottom="4px">
          <Box display="flex" alignItems="center">
            ...
            <Box>
              <Text color="#1E1E1E" fontSize="18px" fontWeight="600">
                macOS computer
              </Text>
              <Text color="#1E1E1E" fontSize="14px">
