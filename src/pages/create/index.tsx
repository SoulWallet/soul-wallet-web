  ...
  if (passKeys.length > 1) {
    return (
      <FullscreenContainer>
        ...
        <Box margin="48px 0"><PassKeyList passKeys={passKeys} /></Box>
        <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" marginTop="20px">
          <Button onClick={() => {}} _styles={{ width: '282px', borderRadius: '40px' }}>Confirm</Button>
          <TextButton onClick={() => {}}>
            Add another passkey
          </TextButton>
        </Box>
    ...
    <FullscreenContainer>
      <Box width="480px" display="flex" flexDirection="column" alignItems="center" justifyContent="center">
        <Box marginBottom="12px">
          <Steps backgroundColor="#1E1E1E" foregroundColor="white" count={3} activeIndex={1} marginTop="24px" onStepChange={onStepChange} />
        </Box>
        <Box display="flex" alignItems="center" justifyContent="center" flexDirection="column">
        ...
        <Box display="flex" alignItems="center" justifyContent="center" flexDirection="column">
          <TextBody colort="#1E1E1E">Next, try signing in with your passkey on a different device! One passkey won’t be backed up. If you lose it, you may be locked out of your account.</TextBody>
        </Box>
      </Box>
      <Box margin="48px 0"><PassKeyList passKeys={passKeys} /></Box>
      <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" marginTop="20px">
        <Button onClick={addPassKey} _styles={{ width: '282px', borderRadius: '40px' }}>Add another passkey</Button>
        <TextButton onClick={() => {}}>
          Skip for now
        </TextButton>
      </Box>
