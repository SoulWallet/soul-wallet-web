    ...
    <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center" paddingBottom="20px">
      ...
      <Button
        ...
        _styles={{
          ...
          marginTop: '12px',
          position: 'relative',
          background: uploaded ? '#EE3F99' : undefined,
          _hover: { background: uploaded ? '#EE3F99' : undefined },
        }}
      >
      ...
      {!!showMannualInput && (
        <>
          ...
          <Box display="flex" flexDirection="column" alignItems="center" marginTop="12px" width="100%">
            <Button disabled={disabled} loading={loading} onClick={handleSubmit} _styles={{ width: '350px' }}>
              Next
            </Button>
          </Box>
        </>
