...
import { GuardianState, createGuardianStore } from '@/store/guardian';
...
export default function SetGuardians({ onStepChange, getPassword }: any) {
  ...
  const handleSkip = async () => {
    try {
      ...
      setLoading(false);
      handleJumpToTargetStep(CreateStepEn.Completed);
    } catch (error: any) {
      setLoading(false);
      toast({
        title: error.message,
    ...
    return (
      <Box maxWidth="480px" display="flex" flexDirection="column" alignItems="center" justifyContent="center">
        ...
        >
          ...
          <TextBody width="100%" marginBottom="1em">
            Guardians are required to recover your wallet. You will need to pay a transaction network fee when setting
            up your guardians after wallet creation. You can learn more here
          </TextBody>
          <Heading3 width="100%">Can I change my guardians in the future?</Heading3>
          <TextBody width="100%" marginBottom="1em">
            Yes. You can always setup or change your guardians through wallet home page. (Network fee will occur.)
          </TextBody>
          <Button width="100%" onClick={() => setSkipping(false)}>
            Set guardians now
          </Button>
    ...
    return (
      ...
      >
        ...
        <Box display="flex" flexDirection="column" alignItems="center" marginTop="0.75em">
          ...
          <TextButton color="rgb(137, 137, 137)" onClick={onSkip} _styles={{ width: '455px' }}>
            Skip for now
          </TextButton>
        </Box>
      </Box>
