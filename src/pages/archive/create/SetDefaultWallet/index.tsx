...
const SetDefaultWallet = () => {
  ...
  return (
    ...
    >
      <WalletCard
        statusText="SET AS DEFAULT"
        steps={<Steps backgroundColor="#29510A" foregroundColor="#E2FC89" count={3} activeIndex={2} marginTop="24px" />}
      />
      <Heading1>Set as default wallet</Heading1>
      <Box marginBottom="2em">
        <TextBody textAlign="center" maxWidth="400px">
          Boost your Ethereum journey by setting Soul Wallet as your primary plugin wallet. You can always easily change
          this setting.
        </TextBody>
      </Box>
